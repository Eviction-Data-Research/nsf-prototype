...
function PotentialEvictions({
  ...
  if (suggestions.length === 0) {
    return <Text>No current suggestions for this property.</Text>;
  }
  ...
  const rowVirtualizer = useVirtualizer({
    count: Math.ceil(suggestions.length / NUM_COLUMNS),
            ...
            >
              <Flex
                ...
                w={
                  ...
                  virtualRow.index === Math.ceil(suggestions.length / 2) - 1
                    ? "50%"
                    : "100%"
                }
                gap={2}
...
export default PotentialEvictions;
